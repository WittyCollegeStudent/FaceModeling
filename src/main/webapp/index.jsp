  ...
  <body>
    <div class="container">
      <div class="header clearfix">
        ...
        <h3 class="text-muted">FaceModeling</h3>
      </div>

      <div class="jumbotron" hight="80%">
        <h1>Image is required</h1>
      </div>
      <div align="center">
        <a class="btn btn-lg btn-success" href="#" role="button">Click to upload</a>
        <a class="btn btn-lg btn-success" href="#" role="button">Download fx.asf</a>
      </div>
